/**
 * article_categoryValidation.js
 * @description :: validate each post and put request as per article_category model
 */
...
/** validation keys and properties of article_category for filter documents from collection */
