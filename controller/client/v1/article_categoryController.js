/**
 * article_categoryController.js
 * @description : exports action methods for article_category.
 */

const Article_category = require('../../../model/article_category');
const article_categorySchemaKey = require('../../../utils/validation/article_categoryValidation');
...
const findAllArticle_category = async (req,res) => {
  try {
    ...
    let validateRequest = validation.validateFilterWithJoi(
      req.body,
      article_categorySchemaKey.findFilterKeys,
      Article_category.schema.obj
    );
    if (!validateRequest.isValid) {
...
/**
 * @description : update multiple records of Article_category with data by filter.
 ...
 */
const deleteManyArticle_category = async (req, res) => {
  try {
...
module.exports = {
  addArticle_category,
  bulkInsertArticle_category,
  findAllArticle_category,
  getArticle_category,
  getArticle_categoryCount,
  updateArticle_category,
  bulkUpdateArticle_category,
  partialUpdateArticle_category,
